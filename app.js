...
function showMessageToast(name,text){let t=document.querySelector(".message-toast");if(!t){t=document.createElement("div");t.className="message-toast";document.body.appendChild(t)}t.innerHTML="<b>💬 "+escapeHtml(name)+"</b><span>"+escapeHtml(text||"رسالة جديدة")+"</span>";t.classList.add("show");clearTimeout(window.__messageToastTimer);window.__messageToastTimer=setTimeout(()=>t.classList.remove("show"),4500)}
