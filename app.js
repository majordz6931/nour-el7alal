...
async function getLikePeople(ids){
 ...
 const {data,error}=await supabaseClient.from("profiles").select("id,username,full_name,wilaya,age,avatar_url,avatar_path,is_online,last_seen,marital_status,profession,verified").in("id",clean);
